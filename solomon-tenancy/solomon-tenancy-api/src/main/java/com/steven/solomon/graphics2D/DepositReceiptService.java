...
public class DepositReceiptService extends AbsReceiptService<DepositReceipt>{
  ...
  public Graphics2D drawDescribe(Graphics2D g2, DepositReceipt receipt) {
    ...
    g2.drawString("收款人:" + receipt.getPayee(),startWidth*63, startHeight+rowheight*5-20);
  ...
  public void upload(BufferedImage bufferedImage) throws Exception {
    minioUtils.putObject("depositReceipt",bufferedImage, DateTimeUtils.getLocalDateTimeString(DateTimeFormatter.ofPattern("yyyy年MM月dd日 HH时mm分ss秒SSS毫秒"))+".jpg",
